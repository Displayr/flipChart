...
dat.with.factors <- structure(list(Income = structure(c(7L, 4L, 7L, 2L, NA, 3L, 7L),
    ...
    "$150,001 to $200,000", "$200,001 or more"), class = "factor",
    questiontype = "PickOne", dataset = "Cola Tracking - January to December.sav",
    values = c(`Less than $15,000` = 3000, `$15,001 to $30,000` = 22000,
    `$30,001 to $45,000` = 37000, `$45,001 to $60,000` = 51000,
    `$60,001 to $90,000` = 72000, `$90,001 to $120,000` = 103000,
    `$120,001 to $150,000` = 132000, `$150,001 to $200,000` = 168000,
    `$200,001 or more` = 280000), sourcevalues = c(`Less than $15,000` = 3000,
    `$15,001 to $30,000` = 22000, `$30,001 to $45,000` = 37000, `$45,001 to $60,000` = 51000,
    `$60,001 to $90,000` = 72000, `$90,001 to $120,000` = 103000,
    `$120,001 to $150,000` = 132000, `$150,001 to $200,000` = 168000,
    `$200,001 or more` = 280000), codeframe = list(`Less than $15,000` = 3000,
    `$15,001 to $30,000` = 22000, `$30,001 to $45,000` = 37000,
    `$45,001 to $60,000` = 51000, `$60,001 to $90,000` = 72000,
    `$90,001 to $120,000` = 103000, `$120,001 to $150,000` = 132000,
    `$150,001 to $200,000` = 168000, `$200,001 or more` = 280000,
    NET = c(3000, 22000, 37000, 51000, 72000, 103000, 132000,
    168000, 280000)), name = "d2", label = "Income", question = "Income"),
    Age = structure(c(2L, 6L, 8L, 8L, 4L, 9L, 6L), levels = c("18 to 24",
    "25 to 29", "30 to 34", "35 to 39", "40 to 44", "45 to 49",
    "50 to 54", "55 to 64", "65 or more"), class = "factor",
    questiontype = "PickOne", dataset = "Cola Tracking - January to December.sav",
    values = c(`18 to 24` = 21, `25 to 29` = 27, `30 to 34` = 32,
    `35 to 39` = 37, `40 to 44` = 42,`45 to 49` = 47, `50 to 54` = 52,
    `55 to 64` = 60, `65 or more` = 77), sourcevalues = c(`18 to 24` = 21,
    `25 to 29` = 27, `30 to 34` = 32,
    `35 to 39` = 37, `40 to 44` = 42, `45 to 49` = 47, `50 to 54` = 52,
    ...
    NET = c(21, 27, 32, 37, 42, 47, 52, 60, 77)), name = "d1", label = "Age", question = "Age")),
    row.names = 1:7, scatter.variable.indices = c(x = 1, y = 2, sizes = NA, colors = 2, groups = NA),
    class = "data.frame")
